...
- **"Contribution"** means any original work of authorship, including any
  ...
  submitted by you to this Project for inclusion in, or documentation of,
  any of the products managed by the Company (the "Work").

- **"Submit"** means any form of electronic, verbal, or written communication
  sent to the Project, including but not limited to pull requests, issues,
  patches, commits, emails, and messages on project communication channels.
...
You understand and agree that the Project is dual-licensed under:

1. **GNU Affero General Public License v3.0 (AGPL-3.0)** — for open source use
2. **Nervosys Commercial License** — for proprietary/commercial use

Your Contributions may be distributed under either or both of these licenses.
This dual-license model is essential to the sustainability of the Project.
...
- You are not aware of any third-party claims, liens, or encumbrances on
  your Contributions.

## 6. You Provide Contributions "As Is"
...
the extent you desire to do so. Support may be provided for free, for a fee,
or not at all.
...
to these terms. For the avoidance of doubt, please include the following line
...
Alternatively, you may sign by emailing [hello@nervosys.ai](mailto:hello@nervosys.ai)
with the subject line "CLA Signature — [Your Name]".
