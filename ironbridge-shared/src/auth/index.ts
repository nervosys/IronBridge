...
// =============================================================================
// IRONBRIDGE Authentication Module
// =============================================================================
// Client-side authentication for IRONBRIDGE sync services
...
const STORAGE_KEYS = {
    ACCESS_TOKEN: 'ironbridge_access_token',
    REFRESH_TOKEN: 'ironbridge_refresh_token',
    TOKEN_EXPIRY: 'ironbridge_token_expiry',
    USER: 'ironbridge_user',
} as const;
