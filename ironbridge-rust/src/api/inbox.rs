...
//! `ironbridge-web/src/components/AgentInbox.tsx` field for field, and serialize as
...
/// Records inbox events against the IronBridge database.
///
...
mod tests {
    ...
    fn temp_db(tag: &str) -> PathBuf {
        let dir = std::env::temp_dir().join(format!("ironbridge_inbox_{}_{}", tag, new_id("t")));
