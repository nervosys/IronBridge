...
pub fn list_agents(verbose: bool) -> Result<()> {
    ...
    println!(
        "{}",
        "|              IRONBRIDGE Agent Development Kit (Agency)                   |".cyan()
    );
    println!(
        "{}",
        "+===================================================================+".cyan()
...
pub fn list_modes() -> Result<()> {
    ...
    println!("  ironbridge Agency run --orchestration swarm \"Build a web scraper\"");
...
pub fn run_agent(
    ...
    println!(
        "{}",
        "   Use 'ironbridge api serve' to start the backend API,".dimmed()
    );
    println!(
        "{}",
        "   then use ironbridge-web or vscode-extension for full agent execution.".dimmed()
    );
    println!();
...
pub fn list_templates() -> Result<()> {
    ...
    println!("{}", "Usage:".dimmed());
    println!("  Select a template in ironbridge-web or vscode-extension to create a swarm.");
