...
//! MCP Tools - Expose ironbridge functionality as MCP tools
...
pub fn list_tools() -> Vec<Tool> {
    vec![
        Tool {
            name: "ironbridge_list_workspaces".to_string(),
        ...
        Tool {
            name: "ironbridge_find_workspace".to_string(),
            description: Some(
        ...
        Tool {
            name: "ironbridge_list_sessions".to_string(),
            description: Some(
        ...
        Tool {
            name: "ironbridge_list_orphaned".to_string(),
            description: Some(
        ...
        Tool {
            name: "ironbridge_register_all".to_string(),
            description: Some(
        ...
        Tool {
            name: "ironbridge_register_sessions".to_string(),
        ...
        Tool {
            name: "ironbridge_show_session".to_string(),
        ...
        Tool {
            name: "ironbridge_show_history".to_string(),
        ...
        Tool {
            name: "ironbridge_merge_sessions".to_string(),
        ...
        Tool {
            name: "ironbridge_search".to_string(),
        ...
        Tool {
            name: "ironbridge_detect".to_string(),
            description: Some(
        ...
        Tool {
            name: "ironbridge_db_get_session".to_string(),
            description: Some(
                "Get a specific session with all its messages from IRONBRIDGE database".to_string(),
            ),
            input_schema: json!({
                "type": "object",
                "properties": {
        ...
        Tool {
            name: "ironbridge_db_search".to_string(),
            description: Some("Search sessions in IRONBRIDGE database by title".to_string()),
            input_schema: json!({
                "type": "object",
                "properties": {
                    "query": {
...
pub fn call_tool(name: &str, arguments: &HashMap<String, serde_json::Value>) -> CallToolResult {
    let result = match name {
        "ironbridge_list_workspaces" => execute_list_workspaces(),
        ...
        // IRONBRIDGE Database tools (ironbridge-web integration)
        "ironbridge_db_list_workspaces" => execute_db_list_workspaces(),
        ...
        "ironbridge_db_stats" => execute_db_stats(),
        _ => CallToolResult {
...
fn execute_register_all(path: Option<&str>, merge: bool, force: bool) -> CallToolResult {
    ...
    match register_all(path, merge, force, false, false, false) {
        Ok(_) => CallToolResult {
            content: vec![ToolContent::Text {
                text: json!({
                    "status": "success",
...
// ============================================================================
// IRONBRIDGE Database Tool Implementations (ironbridge-web integration)
// ============================================================================
...
fn execute_db_list_workspaces() -> CallToolResult {
        ...
        return CallToolResult {
            content: vec![ToolContent::Text {
                text: json!({
                    ...
                    "message": "The ironbridge-web database has not been initialized. Run 'ironbridge api' to start the API server first.",
    ...
    match db::list_db_workspaces() {
        ...
        Err(e) => CallToolResult {
            content: vec![ToolContent::Text {
                text: format!("Error listing workspaces from IRONBRIDGE database: {}", e),
            }],
            is_error: Some(true),
        },
    }
...
fn execute_db_list_sessions(
    ...
    if !db::ironbridge_db_exists() {
        return CallToolResult {
            content: vec![ToolContent::Text {
                text: json!({
                    "error": "IRONBRIDGE database not found",
                    "message": "The ironbridge-web database has not been initialized."
                })
                .to_string(),
            }],
            is_error: Some(true),
    ...
    match db::list_db_sessions(workspace_id, provider, limit) {
        ...
        Err(e) => CallToolResult {
            content: vec![ToolContent::Text {
                text: format!("Error listing sessions from IRONBRIDGE database: {}", e),
            }],
            is_error: Some(true),
        },
    }
