...
/// CHAt System Manager (ironbridge) - Manage and merge chat sessions across workspaces
#[derive(Parser)]
#[command(name = "ironbridge")]
...
pub enum Commands {
    ...
    // ============================================================================
    /// Internal commands used by ironbridge background processes
    #[command(hide = true)]
    Internal {
        #[command(subcommand)]
...
pub enum TelemetryCommands {
    ...
    Setup {
        ...
        /// Service name (default: ironbridge-cli)
        #[arg(long, default_value = "ironbridge-cli")]
        service_name: String,
    },
}
...
pub enum SchemaCommands {
    ...
    Show {
        /// Schema version ID (use `ironbridge schema list` to see available IDs)
        schema_id: String,
