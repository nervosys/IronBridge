...
impl IntegrationRegistry {
    ...
    fn register_all(&mut self) {
        ...
        self.register(Integration {
            ...
            is_native: true,
            platforms: vec!["all".to_string()],
            setup_instructions: Some("Set vault path in IRONBRIDGE settings".to_string()),
        });
