...
//! Chat System Manager (ironbridge) - Main entry point
//!
...
fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Fetch { command } => match command {
            ...
            None => {
                eprintln!("Usage: ironbridge fetch <workspace|session|path> ...");
                eprintln!("Run 'ironbridge fetch --help' for more information.");
                Ok(())
            }
        },
        ...
        Commands::Merge { command } => match command {
            ...
            None => {
                eprintln!("Usage: ironbridge merge <workspace|workspaces|sessions|path|provider|providers|all> ...");
                eprintln!("Run 'ironbridge merge --help' for more information.");
                Ok(())
            }
        },
        ...
        Commands::Export { command } => match command {
            ...
            None => {
                eprintln!("Usage: ironbridge export <workspace|sessions|path|batch> ...");
                eprintln!("Run 'ironbridge export --help' for more information.");
                Ok(())
            }
        },
        ...
        Commands::Import { command } => match command {
            ...
            None => {
                eprintln!("Usage: ironbridge import <workspace|sessions|path> ...");
                eprintln!("Run 'ironbridge import --help' for more information.");
                Ok(())
            }
        },
        ...
        Commands::Move { command } => match command {
            ...
            None => {
                eprintln!("Usage: ironbridge move <workspace|sessions|path> ...");
                eprintln!("Run 'ironbridge move --help' for more information.");
                Ok(())
            }
        },
...
fn generate_completions(shell: CompletionShell) {
    ...
    generate(shell, &mut cmd, "ironbridge", &mut std::io::stdout());
}
