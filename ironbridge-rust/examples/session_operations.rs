//! Session manipulation examples for IRONBRIDGE library
//!
//! Run with: cargo run --example session_operations

use ironbridge::models::{ChatMessage, ChatRequest, ChatSession};
use ironbridge::workspace::{find_workspace_by_path, get_chat_sessions_from_workspace};
use uuid::Uuid;

fn main() -> anyhow::Result<()> {
    println!("=== IRONBRIDGE Session Operations Examples ===\n");
    ...
    ChatSession {
        ...
        requests: vec![ChatRequest {
            ...
            message: Some(ChatMessage {
                text: Some("Hello, how can I use IRONBRIDGE?".to_string()),
                parts: None,
            }),
            response: Some(serde_json::json!({
                "value": [{"value": "IRONBRIDGE helps you manage VS Code chat sessions!"}]
            })),
