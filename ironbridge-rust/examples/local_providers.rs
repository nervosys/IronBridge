//! Local provider examples for IRONBRIDGE library
//!
...
use ironbridge::providers::discovery::discover_all_providers;
...
fn main() -> anyhow::Result<()> {
    println!("=== IRONBRIDGE Local Provider Examples ===\n");
    ...
    for ws in workspaces.iter().take(5) {
        if ws.chat_session_count > 0 {
            println!(
                ...
                ws.project_path
                    .clone()
                    .unwrap_or_else(|| ironbridge::text::head(&ws.hash, 12)),
    ...
    let chat_session: ironbridge::models::ChatSession = generic_session.clone().into();
    ...
    // ========================================================================
    // Example 8: IRONBRIDGE configuration with multiple providers
    // ========================================================================
    println!("\n8. Multi-provider IRONBRIDGE configuration:");
