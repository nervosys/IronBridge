...
use ironbridge::providers::config::ProviderType;
...
mod cloud_provider_trait_tests {
    use ironbridge::providers::cloud::anthropic::AnthropicProvider;
    use ironbridge::providers::cloud::chatgpt::ChatGPTProvider;
    use ironbridge::providers::cloud::common::CloudProvider;
    use ironbridge::providers::cloud::deepseek::DeepSeekProvider;
    use ironbridge::providers::cloud::gemini::GeminiProvider;
    use ironbridge::providers::cloud::m365copilot::M365CopilotProvider;
    use ironbridge::providers::cloud::perplexity::PerplexityProvider;
...
mod http_client_tests {
    use ironbridge::providers::cloud::common::HttpClientConfig;
    ...
    fn test_http_client_config_default() {
        ...
        assert!(config.user_agent.starts_with("ironbridge/"));
