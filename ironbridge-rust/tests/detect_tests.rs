...
mod provider_detection_tests {
    use ironbridge::providers::{ProviderRegistry, ProviderType};
...
mod workspace_detection_tests {
    use ironbridge::workspace::{find_workspace_by_path, normalize_path};
...
mod provider_name_parsing_tests {
    use ironbridge::providers::ProviderType;
