...
mod decode_workspace_folder_tests {
    use ironbridge::workspace::decode_workspace_folder;
...
mod workspace_storage_path_tests {
    use ironbridge::workspace::get_workspace_storage_path;
...
mod get_workspace_by_hash_tests {
    use ironbridge::workspace::get_workspace_by_hash;
...
mod get_workspace_by_path_tests {
    use ironbridge::workspace::get_workspace_by_path;
...
mod find_workspace_by_path_tests {
    use ironbridge::workspace::find_workspace_by_path;
...
mod find_all_workspaces_for_project_tests {
    use ironbridge::workspace::find_all_workspaces_for_project;
...
mod get_chat_sessions_from_workspace_tests {
    use super::*;
    use ironbridge::workspace::get_chat_sessions_from_workspace;
...
mod workspace_integration_tests {
    ...
    fn test_workspace_json_parsing() {
        ...
        let parsed: ironbridge::models::WorkspaceJson = serde_json::from_str(&content).unwrap();
...
mod workspace_edge_cases {
    ...
    fn test_workspace_empty_workspace_json() {
        ...
        let parsed: Result<ironbridge::models::WorkspaceJson, _> = serde_json::from_str(&content);
        assert!(parsed.is_ok());
...
mod cross_platform_tests {
    use ironbridge::workspace::{decode_workspace_folder, normalize_path};
...
mod global_storage_path_tests {
    use ironbridge::workspace::{get_empty_window_sessions_path, get_global_storage_path};
