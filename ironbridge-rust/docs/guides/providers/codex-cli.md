...
ironbridge list sessions --provider codexcli

# Harvest
ironbridge harvest run --providers codexcli

# Watch for new sessions
ironbridge watch --agent codex
```
...
- Use `ironbridge run codex` to launch Codex with automatic session capture
