...
Run open-source models locally with Ollama and chat through IronBridge.
...
OLLAMA_HOST=http://localhost:11434 ironbridge run ollama

# List models available on your Ollama instance
ironbridge provider list --type ollama
```
