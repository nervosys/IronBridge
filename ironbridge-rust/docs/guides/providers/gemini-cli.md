...
ironbridge list sessions --provider geminicli

# Harvest
ironbridge harvest run --providers geminicli

# Watch for new sessions
ironbridge watch --agent gemini
```

## Tips

- Gemini CLI sessions are stored as standard JSON
- Use `ironbridge run gemini` to launch Gemini CLI with automatic session capture
