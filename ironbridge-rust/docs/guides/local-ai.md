...
Run AI models locally for maximum privacy and zero API costs. IronBridge supports all major local inference engines.
...
# Different model
ironbridge run ollama --model codellama
```
...
After chatting with local models through IronBridge, your sessions are automatically captured in the database:
...
ironbridge harvest search "that code fix"
```
