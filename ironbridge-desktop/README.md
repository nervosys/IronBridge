...
# Output locations:
# Windows: target/release/ironbridge-desktop.exe
# macOS:   target/release/bundle/macos/IronBridge.app
# Linux:   target/release/bundle/appimage/ironbridge-desktop.AppImage
```
...
Uses ironbridge-web as the frontend:
- Dev: Connects to Vite dev server at `localhost:5173`
- Prod: Bundles `ironbridge-web/dist` into the binary
