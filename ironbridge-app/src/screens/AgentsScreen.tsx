...
// Agent type tabs matching ironbridge-web
...
// Agent roles with colors and icons (matching ironbridge-web)
...
// Swarm algorithms (matching ironbridge-web)
...
// Consensus protocols (matching ironbridge-web)
...
// Communication protocols (matching ironbridge-web)
...
const SAMPLE_SWE_PROJECTS: SweProject[] = [
    { id: '1', name: 'IronBridge', path: '/dev/ironbridge', language: 'Rust/TS', lastAccessed: '2024-12-12', memoriesCount: 24 },
    { id: '2', name: 'ironbridge-web', path: '/dev/ironbridge/ironbridge-web', language: 'TypeScript', lastAccessed: '2024-12-12', memoriesCount: 18 },
    { id: '3', name: 'ironbridge-app', path: '/dev/ironbridge/ironbridge-app', language: 'TypeScript', lastAccessed: '2024-12-11', memoriesCount: 12 },
];
...
export function AgentsScreen({ navigation }: Props) {
                ...
                <View style={styles.modalContent}>
                    ...
                    {createType === 'swarm' && (
                        <ScrollView style={styles.templatesSection} showsVerticalScrollIndicator={false}>
                            ...
                            {/* Swarm Protocols Section (matching ironbridge-web) */}
    ...
    // Render stats cards (matching ironbridge-web)
    ...
    // Render agent card with details (matching ironbridge-web)
    ...
    // Render activity log (matching ironbridge-web)
