 ...
 * ranked models by them. Nothing in IronBridge measures any of those: no benchmark
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            <View style={[styles.referenceNote, { borderColor: colors.border }]}>
                ...
                <Text style={[styles.referenceNoteText, { color: colors.textSecondary }]}>
                    ...
                    Published list prices and context windows, built into the app. IronBridge does not
