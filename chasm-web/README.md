...
CSM Web connects to the CSM Rust backend API server for all data operations:
...
The web interface works alongside the CSM CLI tool. Run `chasm serve` to start the backend API.
