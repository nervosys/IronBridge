    ...
    return (
        <div className="space-y-6">
            ...
            {/* Stats Cards
              ...
              *   Storage     read "24.8 GB of 500 GB". IronBridge measures neither
              *               number and has no notion of a quota.
              *   GPU         read "87%" on an "RTX 4090". IronBridge does not look
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-[hsl(var(--card))] rounded-xl border w-full max-w-2xl max-h-[80vh] flex flex-col">
                        ...
                        <p className="p-3 text-xs text-[hsl(var(--muted-foreground))] border-t">
                            ...
                            IRONBRIDGE_DOWNLOAD_DIR says otherwise. A file that would not leave 2 GB free
            ...
            {/* Training Tab
              ...
              * provider configured on the server. IronBridge does not train
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-[hsl(var(--card))] rounded-xl border p-6 space-y-4">
                        <div>
                            ...
                            <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">
                                IronBridge hands one of your datasets to the provider configured on the server
            ...
            {activeTab === 'tools' && (
                <div className="space-y-6">
                    {/* Tool Stats
                      ...
                      * these: IronBridge records no tool-call counts anywhere, so
