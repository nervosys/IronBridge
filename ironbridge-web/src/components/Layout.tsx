...
import ironbridgeIcon from '/ironbridge.svg';
                ...
                <div className="h-16 flex items-center justify-between px-4 border-b">
                    {sidebarOpen ? (
                        <div className="flex items-center gap-3">
                            <img src={ironbridgeIcon} alt="IronBridge" className="w-10 h-10" />
                            <div className="flex flex-col">
                                <span className="font-bold text-lg text-[hsl(var(--foreground))] leading-tight">IronBridge</span>
                                <span className="text-xs text-[hsl(var(--muted-foreground))]">Chat System Manager</span>
                            </div>
                        </div>
                    ) : (
                        <img src={ironbridgeIcon} alt="IronBridge" className="w-8 h-8 mx-auto" />
                    )}
                    <button
