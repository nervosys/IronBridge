...
// IronBridge Executor Unit Tests

import * as assert from 'assert';
import { IronBridgeExecutor, WorkspaceInfo, SessionInfo } from '../../ironbridgeExecutor';
...
suite('IronBridgeExecutor Test Suite', () => {
    ...
    suite('parseWorkspaceList', () => {
        ...
        setup(() => {
            ...
            executor = new IronBridgeExecutor(mockChannel as any);
        });
