...
/**
 * Application-level IronBridge service for managing connections and data.
 */
@Service
class IronBridgeService {
    private val logger = Logger.getInstance(IronBridgeService::class.java)
    ...
    companion object {
        fun getInstance(): IronBridgeService =
            ApplicationManager.getApplication().getService(IronBridgeService::class.java)
    }
    ...
    fun configure(url: String) {
        ...
        logger.info("IronBridge server configured: $serverUrl")
    }
