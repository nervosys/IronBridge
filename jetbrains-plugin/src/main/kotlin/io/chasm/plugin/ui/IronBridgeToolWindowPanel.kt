...
/**
 * Main panel for the IronBridge tool window.
 */
class IronBridgeToolWindowPanel(private val project: Project) : SimpleToolWindowPanel(true, true) {

    private val service = IronBridgeService.getInstance()
