...
/**
 * Persistent settings state for the IronBridge plugin.
 */
@State(
    name = "io.ironbridge.plugin.settings.IronBridgeSettings",
    storages = [Storage("IronBridgePlugin.xml")]
)
@Service(Service.Level.APP)
class IronBridgeSettings : PersistentStateComponent<IronBridgeSettings.State> {
    ...
    companion object {
        @JvmStatic
        fun getInstance(): IronBridgeSettings {
            return ApplicationManager.getApplication().getService(IronBridgeSettings::class.java)
        }
    }
}
