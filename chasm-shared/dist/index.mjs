...
function exportToMarkdown(session, options = {}) {
  ...
  lines.push("---");
  lines.push(`*Exported from Chasm on ${formatDate(/* @__PURE__ */ new Date())}*`);
...
<body>
    ...
    <div class="footer">
        Exported from Chasm on ${formatDate(/* @__PURE__ */ new Date())}
    </div>
</body>
</html>`;
...
export { AGENT_ROLES, AGENT_STATUSES, API_CONFIG, API_ENDPOINTS, BUILTIN_TEMPLATES, DEFAULT_AGENTS, DEFAULT_AGENT_CONFIG, DEFAULT_SHORTCUTS, DEFAULT_TAGS, EXPORT_FORMATS, HIGHLIGHT_COLORS, HOOK_ACTIONS, HOOK_TRIGGERS, INTEGRATIONS, INTEGRATION_CATEGORIES, LIMITS, MEMORY_CONFIG, MODEL_CATEGORIES, MULTIMODAL_MODELS, ORCHESTRATION_MODES, PROACTIVE_AGENT_CONFIG, PROVIDERS, PROVIDER_STATUSES, REMOTE_MONITOR_CONFIG, SESSION_FORMAT, SHORTCUT_CATEGORIES, SUBSCRIPTION_TIERS, SWARM_STATUSES, SWARM_TEMPLATES, SWE_PROJECT_TEMPLATES, TAG_COLORS, TASK_STATUSES, TEMPLATE_CATEGORIES, TOOL_CATEGORIES, VLA_MODELS, VLM_MODELS, api, capitalize, chunk, countTotalTokens, createApiClient, debounce, deepClone, deepMerge, delay, downloadExport, estimateTokenCount, exportSession, exportToHtml, exportToJson, exportToMarkdown, exportToPdf, extractFirstLine, extractSessionTitle, formatBytes, formatDate, formatDateISO, formatDuration, formatNumber, formatRelativeTime, formatShortcut, formatTime, formatTokens, generateShortId, generateTimestampId, generateUUID, getDirectory, getExtension, getFileName, getModelsByCategory, getVLAModels, getVLMModels, groupBy, hexToRgb, initialSelectionState, isColorDark, isToday, isValidJson, isValidUUID, isValidUrl, isWithinDays, matchesShortcut, normalizePath, omit, parseKeyboardEvent, pick, retry, rgbToHex, safeJsonParse, selectionReducer, slugify, sortBy, stripMarkdown, throttle, toTitleCase, truncate, uniqueBy };
