...
function SyncProvider({
  ...
  return /* @__PURE__ */ jsx(SyncContext.Provider, { value, children });
}
...
function withSync(WrappedComponent) {
  return function WithSyncComponent(props) {
    ...
    return /* @__PURE__ */ jsx(WrappedComponent, { ...props, sync });
  };
}
...
export { AGENT_ROLES, AGENT_STATUSES, API_CONFIG, API_ENDPOINTS, AuthError, AuthProvider, AuthService, DEFAULT_AGENTS, DEFAULT_AGENT_CONFIG, EXPORT_FORMATS, HOOK_ACTIONS, HOOK_TRIGGERS, INTEGRATIONS, INTEGRATION_CATEGORIES, LIMITS, MEMORY_CONFIG, MODEL_CATEGORIES, MULTIMODAL_MODELS, ORCHESTRATION_MODES, PROACTIVE_AGENT_CONFIG, PROVIDERS, PROVIDER_STATUSES, REMOTE_MONITOR_CONFIG, SESSION_FORMAT, SUBSCRIPTION_TIERS, SWARM_STATUSES, SWARM_TEMPLATES, SWE_PROJECT_TEMPLATES, SyncProvider, SyncService, TASK_STATUSES, TOOL_CATEGORIES, VLA_MODELS, VLM_MODELS, api, capitalize, chunk, countTotalTokens, createApiClient, createSyncService, debounce, deepClone, deepMerge, delay, estimateTokenCount, extractFirstLine, extractSessionTitle, formatBytes, formatDate, formatDateISO, formatDuration, formatNumber, formatRelativeTime, formatTime, formatTokens, generateClientId, generateShortId, generateTimestampId, generateUUID, getAuthService, getDefaultSyncService, getDirectory, getExtension, getFileName, getModelsByCategory, getVLAModels, getVLMModels, groupBy, hexToRgb, initAuthService, initDefaultSyncService, isColorDark, isToday, isValidJson, isValidUUID, isValidUrl, isWithinDays, normalizePath, omit, pick, retry, rgbToHex, safeJsonParse, slugify, sortBy, stripMarkdown, throttle, toTitleCase, truncate, uniqueBy, useApiKeys, useAuth, useDeviceSessions, useRequireAuth, useSubscription, useSync, useSyncConflicts, useSyncContext, useSyncStatus, useSyncSubscription, useSyncedAgents, useSyncedProviders, useSyncedSessions, useSyncedState, useSyncedSwarms, useSyncedWorkspaces, useUser, withSync };
