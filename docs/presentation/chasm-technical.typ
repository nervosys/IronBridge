...
// Compile: typst compile chasm-technical.typ chasm-technical.pdf
  ...
  page(
    ...
    header: rect(width: 100%, height: 14pt, fill: primary.transparentize(90%))[
      #grid(
        ...
        inset: (x: 12pt),
        text(size: 6pt, fill: primary, tracking: 0.5pt)[CHASM TECHNICAL OVERVIEW],
...
#set document(
  title: "Chasm Technical Deep-Dive",
  author: "Nervosys LLC",
...
#content-slide(title: "Mission Critical Problem")[
  #grid(
    ...
    [
      #tech-card(title: "Chasm Solution", accent-color: success)[
        #v(4pt)
        #grid(
          columns: (auto, 1fr),
          gutter: 6pt,
  ...
  #grid(
    ...
    [
      #tech-card(title: "Core Components")[
        ...
        #rect(fill: bg-panel, radius: 3pt, inset: 8pt, width: 100%)[
          #grid(
            columns: (1fr, auto),
            text(size: 8pt, fill: text-primary, weight: "semibold")[chasm-rust], status-badge("OPERATIONAL", success),
          )
          #v(2pt)
        ...
        #rect(fill: bg-panel, radius: 3pt, inset: 8pt, width: 100%)[
          #grid(
            columns: (1fr, auto),
            text(size: 8pt, fill: text-primary, weight: "semibold")[chasm-web], status-badge("OPERATIONAL", success),
          )
          #v(2pt)
        ...
        #rect(fill: bg-panel, radius: 3pt, inset: 8pt, width: 100%)[
          #grid(
            columns: (1fr, auto),
            text(size: 8pt, fill: text-primary, weight: "semibold")[chasm-desktop],
        ...
        #rect(fill: bg-panel, radius: 3pt, inset: 8pt, width: 100%)[
          #grid(
            columns: (1fr, auto),
            text(size: 8pt, fill: text-primary, weight: "semibold")[chasm-app], status-badge("OPERATIONAL", success),
          )
          #v(2pt)
    ...
    [
      #code-block(
        title: "src/main.rs",
        lang: "rust",
        "// Chasm Core Server — Defense-Grade Session Management
use axum::{Router, routing::get};
use chasm_core::{Database, SessionHarvester, MCP};
use tower_http::cors::CorsLayer;

#[tokio::main]
async fn main() -> Result<()> {
    // Initialize encrypted SQLite with FTS5
    let db = Database::open_encrypted(\"chasm.db\", &key)?;
...
#content-slide(title: "CLI Operations", subtitle: "Power User Workflows")[
  #grid(
    ...
    [
      ...
      #v(4pt)
      #terminal-block(
        "$ chasm list workspaces --format table
...
Total: 4 workspaces, 293 sessions",
      ...
      #v(4pt)
      #terminal-block(
        "$ chasm search \"authentication vulnerability\" --limit 5
...
[2] Session: security-review-jan (2 matches)
    ...
    [
      ...
      #v(4pt)
      #terminal-block(
        "$ chasm harvest run --provider all --verbose
...
[SUCCESS] Harvest complete
  ...
  Updated: 58",
      ...
      #v(4pt)
      #terminal-block(
        "$ chasm export --format json --encrypt \\
  ...
  #grid(
    ...
    [
      #rect(fill: bg-panel, stroke: 1pt + primary.transparentize(60%), radius: 4pt, inset: 4pt)[
        #image("screenshots/chasm_web_home.png", width: 100%)
      ]
      #v(4pt)
  ...
  #grid(
    ...
    [
      #rect(fill: bg-panel, stroke: 1pt + secondary.transparentize(60%), radius: 4pt, inset: 4pt)[
        #image("screenshots/chasm_web_agents.png", width: 100%)
      ]
      #v(4pt)
    ...
    [
      #rect(fill: bg-panel, stroke: 1pt + success.transparentize(60%), radius: 4pt, inset: 4pt)[
        #image("screenshots/chasm_web_agents_inbox.png", width: 100%)
      ]
      #v(4pt)
...
#screenshot-slide(
  ...
  path: "screenshots/chasm_web_comparison.png",
  caption: "Side-by-side comparison of AI provider responses",
)

#screenshot-slide(
  title: "Web — Developer Tools",
  path: "screenshots/chasm_web_developer.png",
  ...
  #grid(
    ...
    [
      ...
      #rect(fill: bg-card, stroke: 1pt + warning.transparentize(60%), radius: 4pt, inset: 10pt)[
        #grid(
          ...
          gutter: 4pt,
          align: center,
          [#image("screenshots/chasm_desktop_home.png", width: 100%)],
          [#image("screenshots/chasm_desktop_chat.png", width: 100%)],
          [#image("screenshots/chasm_desktop_agents.png", width: 100%)],
        )
        #v(4pt)
    ...
    [
      #rect(fill: bg-panel, stroke: 1pt + warning.transparentize(60%), radius: 4pt, inset: 4pt)[
        #image("screenshots/chasm_desktop_overview.png", width: 100%)
      ]
      #v(4pt)
  ...
  #grid(
    ...
    [
      #rect(fill: bg-card, stroke: 1pt + primary.transparentize(60%), radius: 12pt, inset: 6pt)[
        #image("screenshots/chasm_app_home.png", width: 100%)
      ]
      #v(4pt)
      #align(center)[
    ...
    [
      #rect(fill: bg-card, stroke: 1pt + success.transparentize(60%), radius: 12pt, inset: 6pt)[
        #image("screenshots/chasm_app_workspaces.png", width: 100%)
      ]
      #v(4pt)
      #align(center)[
    ...
    [
      #rect(fill: bg-card, stroke: 1pt + warning.transparentize(60%), radius: 12pt, inset: 6pt)[
        #image("screenshots/chasm_app_sessions.png", width: 100%)
      ]
      #v(4pt)
      #align(center)[
    ...
    [
      #rect(fill: bg-card, stroke: 1pt + secondary.transparentize(60%), radius: 12pt, inset: 6pt)[
        #image("screenshots/chasm_app_chat.png", width: 100%)
      ]
      #v(4pt)
      #align(center)[
  ...
  #grid(
    ...
    [
      ...
      #code-block(
        title: "Commands",
        lang: "text",
        "Chasm: Show Sessions        Ctrl+Shift+S
Chasm: Search History       Ctrl+Shift+H
Chasm: Recover Session      Ctrl+Shift+R
Chasm: Start MCP Server     Ctrl+Shift+M
Chasm: Sync Workspace       Ctrl+Shift+Y",
      )
    ],
    [
      #rect(fill: bg-panel, stroke: 1pt + primary.transparentize(60%), radius: 4pt, inset: 4pt)[
...
#content-slide(title: "TypeScript — Type Definitions", subtitle: "Shared types across all platforms")[
  #code-block(
    title: "chasm-shared/src/types/session.ts",
    lang: "typescript",
  ...
  #grid(
    ...
    [
      #tech-card(title: "Standalone", accent-color: primary)[
        ...
        #v(8pt)
        #terminal-block("$ chasm api serve
...
#content-slide(title: "Platform Summary", subtitle: "Why Chasm for Defense")[
  #grid(
    columns: (1fr, 1fr),
    gutter: 1cm,
    [
    ...
    [
      #tech-card(title: "Platform Matrix", accent-color: primary)[
        ...
        #table(
          ...
          inset: 4pt,
          row-gutter: 4pt,
          text(size: 8pt, weight: "bold", fill: primary)[chasm-rust],
          text(size: 7pt, fill: text-muted)[Core API, CLI, harvesting engine],

          text(size: 8pt, weight: "bold", fill: success)[chasm-web],
          text(size: 7pt, fill: text-muted)[Browser dashboard, React 19],

          text(size: 8pt, weight: "bold", fill: warning)[chasm-desktop],
          text(size: 7pt, fill: text-muted)[Native app, Tauri 2],

          text(size: 8pt, weight: "bold", fill: secondary)[chasm-app],
      ...
      #rect(fill: primary, radius: 4pt, inset: 14pt, width: 100%)[
        #align(center)[
          ...
          #v(4pt)
          #text(size: 8pt, fill: bg-dark)[nervosys.ai/chasm]
        ]
      ]
    ],
  )
