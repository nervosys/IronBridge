  ...
  page(
    ...
    footer: [
      ...
      #grid(
        ...
        text(size: 6pt, fill: grey, font: "Inter")[CHASM],
        dfars-footer,
  ...
  page(
    ...
    footer: [
      ...
      #grid(
        columns: (1fr, auto, 1fr),
        align: (left, center, right),
        text(size: 6pt, fill: lightgrey, font: "Inter")[CHASM],
...
#set document(title: "Chasm - Universal AI Chat Session Manager", author: "Nervosys LLC")
  ...
  #rect(
    ...
    #align(center)[
      #text(size: 11pt, fill: white)[
        *CHASM* harvests, merges, and manages AI chat sessions across all providers, platforms, and workspaces.
      ]
    ]
  ]
...
#slide(title: "Architecture", subtitle: "Platform Overview")[
  #grid(
    ...
    // Backend
    [
      #text(size: 7pt, fill: grey, tracking: 0.5pt)[#upper[Chasm Core — Rust]]
      #v(8pt)
      #grid(
        columns: (1fr, 1fr),
        gutter: 6pt,
...
$ chasm detect orphaned /project
$ chasm register all --force
$ chasm show path /secure-comms",
      )
      ...
      #v(6pt)
      #code-block(
        "$ chasm harvest run --provider copilot
$ chasm harvest search \"auth bug\"
$ chasm export json /backup/sessions.json",
      )
    ],
    [
      ...
      #v(6pt)
      #code-block(
        "$ chasm merge providers copilot cursor
$ chasm merge path /secure/project
$ chasm merge workspace --all",
      )
      ...
      #code-block(
        "$ chasm agency list
$ chasm agency run --agent researcher \\
    \"Analyze security logs\"
$ chasm agency run --orchestration swarm \\
    \"Build microservices\"",
      )
      ...
      #v(6pt)
      #code-block("$ chasm api serve --port 8787 --tls")
    ],
  )
]
  ...
  #grid(
    ...
    [
      #box(clip: true, radius: 6pt)[
        #image("screenshots/chasm_cli_list.png", width: 100%)
      ]
    ],
    [
      #box(clip: true, radius: 6pt)[
        #image("screenshots/chasm_cli_agency.png", width: 100%)
      ]
    ],
  )
]
...
#slide(title: "Web Application", subtitle: "Chat Interface")[
  #align(center)[
    #rect(fill: light-bg, radius: 3pt, inset: 4pt)[
      #image("screenshots/chasm_web_chat.png", height: 85%)
    ]
  ]
]
...
#slide(title: "Web Application", subtitle: "Sessions & Workspaces")[
  #grid(
    ...
    [
      #rect(fill: light-bg, radius: 3pt, inset: 4pt, width: 100%)[
        #image("screenshots/chasm_web_sessions.png", width: 100%)
      ]
      #v(4pt)
    ...
    [
      #rect(fill: light-bg, radius: 3pt, inset: 4pt, width: 100%)[
        #image("screenshots/chasm_web_workspaces.png", width: 100%)
      ]
      #v(4pt)
...
#slide(title: "Desktop Application", subtitle: "Agent Management")[
  #align(center)[
    #rect(fill: light-bg, radius: 3pt, inset: 4pt)[
      #image("screenshots/chasm_desktop_agents.png", height: 85%)
    ]
  ]
]
    ...
    #grid(
      ...
      [
        #rect(fill: dark-bg, radius: 12pt, inset: 4pt)[
          #image("screenshots/chasm_app_home.png", height: 75%)
        ]
        #v(4pt)
      ...
      [
        #rect(fill: dark-bg, radius: 12pt, inset: 4pt)[
          #image("screenshots/chasm_app_workspaces.png", height: 75%)
        ]
        #v(4pt)
      ...
      [
        #rect(fill: dark-bg, radius: 12pt, inset: 4pt)[
          #image("screenshots/chasm_app_sessions.png", height: 75%)
        ]
        #v(4pt)
      ...
      [
        #rect(fill: dark-bg, radius: 12pt, inset: 4pt)[
          #image("screenshots/chasm_app_chat.png", height: 75%)
        ]
        #v(4pt)
  ...
  #grid(
    ...
    [
      ...
      #card(title: "Commands")[
        ...
        #v(2pt)
        Chasm: Show Sessions \
        Chasm: Recover Session \
        Chasm: Search History \
        Chasm: Start MCP Server \
        Chasm: Sync Workspace
      ]
    ],
    [
  ...
  #grid(
    ...
    [
      ...
      #rect(fill: light-bg, radius: 3pt, inset: 10pt, width: 100%)[
        ...
        #v(2pt)
        #code-block("$ chasm api serve --tls --port 8787")
      ]
      ...
      #rect(fill: light-bg, radius: 3pt, inset: 10pt, width: 100%)[
        ...
        #v(2pt)
        #code-block("$ docker run ghcr.io/nervosys/chasm")
      ]
      ...
      #rect(fill: light-bg, radius: 3pt, inset: 10pt, width: 100%)[
        ...
        #v(2pt)
        #code-block("$ helm install chasm nervosys/chasm")
      ]
    ],
  )
]
    ...
    [
      #accent-card(title: "Platform Matrix")[
        ...
        #table(
          ...
          inset: 4pt,
          row-gutter: 2pt,
          text(size: 7pt, weight: "bold", fill: text-dark)[chasm-cli],
          text(size: 7pt, fill: grey)[Power users, automation, CI/CD],

          text(size: 7pt, weight: "bold", fill: text-dark)[chasm-web],
          text(size: 7pt, fill: grey)[Browser-based dashboard],

          text(size: 7pt, weight: "bold", fill: text-dark)[chasm-desktop],
          text(size: 7pt, fill: grey)[Native app, system integration],

          text(size: 7pt, weight: "bold", fill: text-dark)[chasm-app],
...
#page(
  ...
  #align(center + horizon)[
    #box(inset: 2cm)[
      ...
      #v(0.5cm)
      #text(size: 9pt, fill: lightgrey)[sales\@nervosys.ai  ·  nervosys.ai/chasm]
      #v(1cm)
