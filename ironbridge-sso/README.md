...
Enterprise single sign-on for IronBridge — OIDC and SAML, with **no native
dependencies**.
...
build effectively impossible — see `ironbridge-rust/docs/api/rest.md` for the full
...
AGPL-3.0-only, with commercial dual-licensing — same terms as the rest of IronBridge.
