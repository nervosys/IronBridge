...
use csm::providers::config::{CsmConfig, ProviderConfig, ProviderType};
use csm::providers::session_format::{GenericMessage, GenericSession};
use csm::providers::ProviderRegistry;
...
mod openai_compat_tests {
    use super::*;
    use csm::providers::openai_compat::{OpenAIChatMessage, OpenAICompatProvider};
    use csm::providers::ChatProvider;
...
mod cursor_provider_tests {
    use super::*;
    use csm::providers::cursor::CursorProvider;
    use csm::providers::ChatProvider;
