...
mod decode_workspace_folder_tests {
    use csm::workspace::decode_workspace_folder;
...
mod normalize_path_tests {
    use csm::workspace::normalize_path;
...
mod workspace_storage_path_tests {
    use csm::workspace::get_workspace_storage_path;
...
mod get_workspace_by_hash_tests {
    use csm::workspace::get_workspace_by_hash;
...
mod get_workspace_by_path_tests {
    use csm::workspace::get_workspace_by_path;
...
mod find_workspace_by_path_tests {
    use csm::workspace::find_workspace_by_path;
...
mod find_all_workspaces_for_project_tests {
    use csm::workspace::find_all_workspaces_for_project;
...
mod get_chat_sessions_from_workspace_tests {
    use super::*;
    use csm::workspace::get_chat_sessions_from_workspace;
...
mod cross_platform_tests {
    use csm::workspace::{decode_workspace_folder, normalize_path};
