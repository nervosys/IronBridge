...
use csm::providers::{
    ProviderType, CloudConversation, CloudMessage, FetchOptions,
    GenericSession, GenericMessage,
};
use csm::providers::cloud::chatgpt::parse_chatgpt_export;
use csm::providers::cloud::anthropic::parse_claude_export;
use csm::providers::cloud::perplexity::parse_perplexity_export;
use csm::providers::cloud::deepseek::parse_deepseek_export;
use csm::providers::cloud::gemini::parse_gemini_export;
use csm::providers::cloud::m365copilot::{parse_m365_copilot_export, get_friendly_app_name};
...
fn main() -> anyhow::Result<()> {
    ...
    let app_classes = ["Office.Word", "Office.Excel", "Office.PowerPoint", 
                       "Office.Outlook", "Teams", "Bing"];
    ...
    let chat_session: csm::models::ChatSession = generic_session.into();
    ...
    let providers_info = [
        (ProviderType::ChatGPT, "https://chat.openai.com/backend-api", "Session token"),
        (ProviderType::Anthropic, "https://claude.ai/api", "Session token"),
        (ProviderType::Perplexity, "https://www.perplexity.ai/api", "Session token"),
        (ProviderType::DeepSeek, "https://chat.deepseek.com/api", "API key"),
        (ProviderType::Gemini, "https://generativelanguage.googleapis.com/v1", "API key"),
        (ProviderType::M365Copilot, "https://graph.microsoft.com/v1.0", "OAuth token"),
    ];
